 ...
 */
@protocol EOCEventDataStore <NSObject>

/**
 * Initialize a new Eyeofcloud data store instance
 *
...
#if TARGET_OS_IOS
@interface EOCEventDataStoreiOS : NSObject<EOCEventDataStore>
@end
#endif

#if TARGET_OS_TV
@interface EOCEventDataStoreTVOS : NSObject<EOCEventDataStore>
@end
#endif
