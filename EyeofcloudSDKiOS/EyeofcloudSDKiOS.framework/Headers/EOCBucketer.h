...
extern NSString *const EOCBucketerMutexPolicy;
extern NSString *const EOCBucketerOverlappingPolicy;
NS_ASSUME_NONNULL_END

/**
 * This protocol describes the behavior any bucketer needs to exhibit to be used in the Eyeofcloud SDK.
 */
@protocol EOCBucketer <NSObject>
 ...
 */
- (nullable EOCVariation *)bucketExperiment:(nonnull EOCExperiment *)experiment
                              withBucketingId:(nonnull NSString *)bucketingId;

@end

/**
 * Default Eyeofcloud bucketing algorithm that evenly distributes users using the Murmur3 hash of some provided identifier.
 * The user ID can not be a null or empty string.
 */
@interface EOCBucketer : NSObject <EOCBucketer>
 ...
 */
- (nullable instancetype)initWithConfig:(nonnull EOCProjectConfig *)config;
 ...
 * @param entityId The ID of the entity the user is being bucketed into. ex: EOCExperiment.experimentId.
