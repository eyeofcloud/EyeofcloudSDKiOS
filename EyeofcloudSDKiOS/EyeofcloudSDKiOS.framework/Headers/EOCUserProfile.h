...
@protocol EOCUserProfile
@end

@interface EOCUserProfile : EOCJSONModel

/// ID identifying the user
@property (nonatomic, strong) NSString *user_id;
/// The experiment bucket map
@property (nonatomic, strong) NSDictionary<NSString *, EOCExperimentBucketMapEntity *> *experiment_bucket_map;
