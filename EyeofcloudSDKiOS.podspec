#
#  Be sure to run `pod spec lint EyeofcloudSDKiOS.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "EyeofcloudSDKiOS.sdk"
  ...
  spec.description  = <<-DESC
			EyeofcloudSDKiOS description 
                   DESC

  spec.homepage     = "https://github.com/eyeofcloud/EyeofcloudSDKiOS.git"
  ...
  # Or just: spec.author    = "zwx"
  # spec.authors            = { "zwx" => "zhangweixue@heliyuntong.cn" }
  # spec.social_media_url   = "https://twitter.com/zwx"
