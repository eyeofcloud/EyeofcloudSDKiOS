...
@protocol EOCAudience
@end

@interface EOCAudience : EOCJSONModel <EOCCondition>
...
@property (nonatomic, strong) NSArray<EOCCondition> *conditions;

/// Override EOCJSONModel set conditions
