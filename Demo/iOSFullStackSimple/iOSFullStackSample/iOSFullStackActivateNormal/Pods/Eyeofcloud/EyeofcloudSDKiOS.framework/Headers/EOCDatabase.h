...
/*
 ...
 Each row entry contains three columns [EOCDatabaseEntity]:
 1. id [int]
 2. json [text]
 3. timestamp [int]
 The table is stored in the Library directory: .../eyeofcloud/database/eoc-database.sqlite
 This feature is not available for tvOS as storage is limited.
 */

#import <Foundation/Foundation.h>

@interface EOCDatabase : NSObject
/**
 * File manager initializer.
 *
 * @param baseDir The base directory where the database will be stored.
 * @return an instance of EOCDatabase.
 **/
