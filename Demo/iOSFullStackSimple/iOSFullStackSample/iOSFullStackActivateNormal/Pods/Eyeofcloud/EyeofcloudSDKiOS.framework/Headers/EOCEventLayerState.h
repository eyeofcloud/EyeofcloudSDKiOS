...
@class EOCEventDecisionTicket, EOCEventDecision;

@protocol EOCEventLayerState
@end

@interface EOCEventLayerState : EOCJSONModel
...
@property (nonatomic, strong, nullable) EOCEventDecisionTicket<Optional> *decisionTicket;
// Output of the Client Decision Engine
@property (nonatomic, strong, nullable) EOCEventDecision<Optional> *decision;
