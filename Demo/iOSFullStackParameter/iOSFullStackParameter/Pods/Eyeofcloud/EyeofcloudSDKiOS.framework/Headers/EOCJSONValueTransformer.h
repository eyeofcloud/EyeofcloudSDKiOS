...
#pragma mark - EOCJSONValueTransformer interface
/**
 ...
 * Just few examples of what can you add to EOCJSONValueTransformer: hex colors in JSON to UIColor,
 * hex numbers in JSON to NSNumber model properties, base64 encoded strings in JSON to UIImage properties, and more.
 *
 * The class is invoked by EOCJSONModel while transforming incoming
 * JSON types into your target class property classes, and vice versa.
 * One static copy is create and store in the EOCJSONModel class scope.
 */
@interface EOCJSONValueTransformer : NSObject
