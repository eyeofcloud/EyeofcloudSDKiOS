...
@class EOCEventHeader;
@protocol EOCEventFeature, EOCEventMetric, EOCEventRelatedEvent, EOCEventLayerState, EOCEventView;

@interface EOCEventTicket : EOCJSONModel
...
@property (nonatomic, strong, nullable) EOCEventHeader<Optional> *header;
...
@property (nonatomic, strong, nonnull) NSArray<EOCEventFeature> *eventFeatures;
// The metrics associated with this event
@property (nonatomic, strong, nullable) NSArray<EOCEventMetric, Optional> *eventMetrics;
// Features attached to the user as chosen through customer config.
@property (nonatomic, strong, nonnull) NSArray<EOCEventFeature> *userFeatures;
// Other events related to this event. E.g. impression and conversion events.
@property (nonatomic, strong, nullable) NSArray<EOCEventRelatedEvent, Optional> *relatedEvents;
// The most recent LayerState for every layer. All layers active when the event happened.
@property (nonatomic, strong, nonnull) NSArray<EOCEventLayerState> *layerStates;
// The views active at the time of the event.
@property (nonatomic, strong, nullable) NSArray<EOCEventView, Optional> *activeViews;
