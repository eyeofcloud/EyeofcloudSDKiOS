...
class EOCOPTViewController: UIViewController {
    
    var eocClient: EOCClient?
    
    let appDelegate = UIApplication.shared.delegate as! AppDelegate
    
    @IBOutlet weak var opt: UILabel!
    
    @IBAction func optclick(_ sender: Any) {
        //opt.text = "目标触发"
    ...
    override func viewDidLoad() {
        ...
        opt.center.x = self.view.center.x
        opt.center.y = self.view!.bounds.height/3
