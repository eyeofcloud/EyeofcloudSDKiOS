...
@protocol EOCEventDecision
@end

@interface EOCEventDecision : EOCJSONModel
...
// TODO - Remove later when this ticket is completed: https://eyeofcloud.atlassian.net/browse/NB-1493
