...
@class EOCEventHeader, EOCEventDecision;
@protocol EOCEventDecisionTicket, EOCEventFeature;

@interface EOCDecisionEventTicket : EOCJSONModel
...
@property (nonatomic, strong, nullable) NSArray<EOCEventDecisionTicket, Optional> *decisionTicket;
// Output of the Client Decision Engine
@property (nonatomic, strong, nonnull) EOCEventDecision *decision;
// The ID of the user
