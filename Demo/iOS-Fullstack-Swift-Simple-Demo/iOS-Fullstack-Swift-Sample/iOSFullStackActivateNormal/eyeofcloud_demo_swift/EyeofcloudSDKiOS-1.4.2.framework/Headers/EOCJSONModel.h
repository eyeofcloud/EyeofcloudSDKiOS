...
#define EOCJMLog( s, ... ) NSLog( @"[%@:%d] %@", [[NSString stringWithUTF8String:__FILE__] \
 ...
 */
@interface NSObject (EOCJSONModelPropertyCompatibility) <Optional, Ignore>
@end

/////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - EOCJSONModel protocol
/**
 * A protocol describing an abstract EOCJSONModel class
 * EOCJSONModel conforms to this protocol, so it can use itself abstractly
 */
@protocol AbstractEOCJSONModelProtocol <NSCopying, NSCoding>

@required
/**
 * All EOCJSONModel classes should implement initWithDictionary:
 *
 * For most classes the default initWithDictionary: inherited from EOCJSONModel itself
...
/**
 * All EOCJSONModel classes should implement initWithData:error:
 *
 * For most classes the default initWithData: inherited from EOCJSONModel itself
 * should suffice, but developers have the option to also overwrite it if needed.
 *
...
/**
 * All EOCJSONModel classes should be able to export themselves as a dictionary of
 * JSON compliant objects.
 *
 * For most classes the inherited from EOCJSONModel default toDictionary implementation
 * should suffice.
 *
 * @return NSDictionary dictionary of JSON compliant objects
 * @exception EOCJSONModelTypeNotAllowedException thrown when one of your model's custom class properties
 * does not have matching transformer method in an EOCJSONValueTransformer.
 */
...
/////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark - EOCJSONModel interface
/**
 * The EOCJSONModel is an abstract model class, you should not instantiate it directly,
 ...
 */
@interface EOCJSONModel : NSObject <AbstractEOCJSONModelProtocol, NSSecureCoding>
...
+ (void)setGlobalKeyMapper:(EOCJSONKeyMapper *)globalKeyMapper DEPRECATED_MSG_ATTRIBUTE("override +keyMapper in a base model class instead");
 ...
 * @exception EOCJSONModelTypeNotAllowedException thrown when unsupported type is found in the incoming JSON,
 * or a property type in your model is not supported by EOCJSONValueTransformer and its categories
 * @see initWithString:usingEncoding:error: for use of custom text encodings
 */
- (instancetype)initWithString:(NSString *)string error:(EOCJSONModelError **)err;
 ...
 * or a property type in your model is not supported by EOCJSONValueTransformer and its categories
 */
- (instancetype)initWithString:(NSString *)string usingEncoding:(NSStringEncoding)encoding error:(EOCJSONModelError **)err;
 ...
 * @exception EOCJSONModelTypeNotAllowedException thrown when unsupported type is found in the incoming JSON,
 * or a property type in your model is not supported by EOCJSONValueTransformer and its categories
 * @exception EOCJSONModelInvalidDataException thrown when the input data does not include all required keys
 ...
 * @param array list of EOCJSONModel objects
 ...
 * This method gets called at the very end of the EOCJSONModel initializer, thus the model is in the state that you would
 ...
 * [EOCJSONModelError errorModelIsInvalid] to set the NSError param if the data fails your custom validation
 */
 ...
 * Lookup EOCJSONKeyMapper docs for more details.
 */
+ (EOCJSONKeyMapper *)keyMapper;
