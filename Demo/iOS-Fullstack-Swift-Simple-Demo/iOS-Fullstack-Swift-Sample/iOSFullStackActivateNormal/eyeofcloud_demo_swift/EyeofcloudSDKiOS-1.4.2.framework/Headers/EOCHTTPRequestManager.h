...
typedef void (^EOCHTTPRequestManagerResponse)(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error);

@interface EOCHTTPRequestManager : NSObject
...
- (void)GETWithURL:(nonnull  NSURL *)url
        completion:(nullable EOCHTTPRequestManagerResponse)completion;
