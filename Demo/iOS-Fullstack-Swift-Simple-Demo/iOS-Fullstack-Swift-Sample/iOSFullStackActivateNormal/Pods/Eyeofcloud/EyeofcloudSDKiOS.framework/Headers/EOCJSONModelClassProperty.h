...
/**
 * **You do not need to instantiate this class yourself.** This class is used internally by EOCJSONModel
 ...
 */
@interface EOCJSONModelClassProperty : NSObject
