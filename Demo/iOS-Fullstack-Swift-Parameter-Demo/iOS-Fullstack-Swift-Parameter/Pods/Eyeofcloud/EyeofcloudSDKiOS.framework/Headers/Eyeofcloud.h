...
extern NSString * _Nonnull const EyeofcloudDidActivateExperimentNotification;
extern NSString * _Nonnull const EyeofcloudDidTrackEventNotification;
extern NSString * _Nonnull const EyeofcloudNotificationsUserDictionaryExperimentKey;
extern NSString * _Nonnull const EyeofcloudNotificationsUserDictionaryVariationKey;
extern NSString * _Nonnull const EyeofcloudNotificationsUserDictionaryUserIdKey;
extern NSString * _Nonnull const EyeofcloudNotificationsUserDictionaryAttributesKey;
extern NSString * _Nonnull const EyeofcloudNotificationsUserDictionaryEventNameKey;
extern NSString * _Nonnull const EyeofcloudNotificationsUserDictionaryEventValueKey;
extern NSString * _Nonnull const EyeofcloudNotificationsUserDictionaryExperimentVariationMappingKey;

@class EOCProjectConfig, EOCVariation;
@protocol EOCBucketer, EOCErrorHandler, EOCEventBuilder, EOCEventDispatcher, EOCLogger;

// ---- Live Variable Getter Errors ----

typedef NS_ENUM(NSInteger, EOCLiveVariableError) {
    EOCLiveVariableErrorNone = 0,
    EOCLiveVariableErrorKeyUnknown
};

@protocol Eyeofcloud <NSObject>
 ...
 */
- (nullable EOCVariation *)activate:(nonnull NSString *)experimentKey
 ...
 * This method bypasses redundant network requests to Eyeofcloud.
 */
 ...
 * @return The variation the user was bucketed into. This value can be nil.
 */
- (nullable EOCVariation *)variation:(nonnull NSString *)experimentKey
                                userId:(nonnull NSString *)userId;
 ...
 */
- (EOCVariation *_Nullable)getForcedVariation:(nonnull NSString *)experimentKey
                                         userId:(nonnull NSString *)userId;
...
/**
 * This class defines the Eyeofcloud SDK interface.
 * Eyeofcloud Instance
 */
@interface Eyeofcloud : NSObject <Eyeofcloud>

@property (nonatomic, strong, readonly, nullable) id<EOCBucketer> bucketer;
//cghui config
@property (nonatomic, strong, nullable) EOCProjectConfig *config;
//@property (nonatomic, strong, readonly, nullable) EOCProjectConfig *config;
@property (nonatomic, strong, readonly, nullable) id<EOCErrorHandler> errorHandler;
@property (nonatomic, strong, readonly, nullable) id<EOCEventBuilder> eventBuilder;
@property (nonatomic, strong, readonly, nullable) id<EOCEventDispatcher> eventDispatcher;
@property (nonatomic, strong, readonly, nullable) id<EOCLogger> logger;
@property (nonatomic, strong, readonly, nullable) id<EOCUserProfileService> userProfileService;

/**
 * Init with builder block
 * @param builderBlock The builder block, where the logger, errorHandler, and eventDispatcher can be set.
 * @return Eyeofcloud instance.
 */
+ (nullable instancetype)init:(nonnull EOCBuilderBlock)builderBlock;
