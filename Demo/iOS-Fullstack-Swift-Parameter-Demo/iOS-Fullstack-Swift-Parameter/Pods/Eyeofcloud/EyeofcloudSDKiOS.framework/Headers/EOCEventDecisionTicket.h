...
@protocol EOCEventAudience;

@protocol EOCEventDecisionTicket
@end

@interface EOCEventDecisionTicket : EOCJSONModel

// The audiences bucketed at decision time
@property (nonatomic, strong, nullable) NSArray<EOCEventAudience, Optional> *audiences;
