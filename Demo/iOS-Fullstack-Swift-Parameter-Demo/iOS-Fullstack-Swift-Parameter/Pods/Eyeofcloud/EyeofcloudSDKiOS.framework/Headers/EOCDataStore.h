...
extern NSInteger const EOCDataStorePercentageOfEventsToRemoveUponOverflow;

@protocol EOCLogger;

// If adding event type, update: stringForDataTypeEnum
typedef NS_ENUM(NSUInteger, EOCDataStoreDataType)
{
    EOCDataStoreDataTypeDatabase,
    EOCDataStoreDataTypeDatafile,
    EOCDataStoreDataTypeEventDispatcher,
    EOCDataStoreDataTypeUserProfile,
    EOCDataStoreDataTypeUserProfileService,
    EOCDataStoreDataTypeCOUNT
};

// If adding data store data type, update: removeSavedEvents, totalNumberOfEvents
typedef NS_ENUM(NSUInteger, EOCDataStoreEventType)
{
    EOCDataStoreEventTypeImpression,
    EOCDataStoreEventTypeConversion,
    EOCDataStoreEventTypeCOUNT
};

@class EOCFileManager;

/*
 * This class handles all Eyeofcloud-related data persistence and caching.
...
- (BOOL)saveFile:(nonnull NSString *)fileName
            ...
            type:(EOCDataStoreDataType)dataType
 ...
 *
 **/
- (bool)dataTypeExists:(EOCDataStoreDataType)dataType;
 ...
 *
 **/
- (BOOL)removeFilesForDataType:(EOCDataStoreDataType)dataType
                         error:(NSError * _Nullable __autoreleasing * _Nullable)error;
...
- (BOOL)saveEvent:(nonnull NSDictionary *)data
        eventType:(EOCDataStoreEventType)eventType
            error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * @param error An error object is returned if an error occurs.
 */
- (nullable NSDictionary *)getOldestEvent:(EOCDataStoreEventType)eventType
                                    error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * @param eventType The event type of the data that needs to be retrieved.
 * @param error An error object is returned if an error occurs.
 * @return The return value is an array of EOCDatabaseEntity.
 */
- (nullable NSArray *)getAllEvents:(EOCDataStoreEventType)eventType
                             error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * @param error An error object is returned if an error occurs.
 */
- (BOOL)removeOldestEvent:(EOCDataStoreEventType)eventType
                    error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 * @param error An error object is returned if an error occurs.
 */
- (BOOL)removeAllEvents:(EOCDataStoreEventType)eventType
                  error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 */
- (NSInteger)numberOfEvents:(EOCDataStoreEventType)eventType
                      error:(NSError * _Nullable __autoreleasing * _Nullable)error;
 ...
 */
- (void)saveUserData:(nonnull NSDictionary *)data type:(EOCDataStoreDataType)dataType;
 ...
 */
- (nullable NSDictionary *)getUserDataForType:(EOCDataStoreDataType)dataType;
 ...
 * @param dataType The type of data (e.g., datafile, user profile, event dispatcher, etc.)
 */
- (void)removeUserDataForType:(EOCDataStoreDataType)dataType;

/**
 * Removes all Eyeofcloud-related data in NSUserDefault.
 */
 ...
 * @param dataType The type of data (e.g., datafile, user profile, event dispatcher, etc.)
 */
- (void)removeObjectInUserData:(nonnull id)dataKey type:(EOCDataStoreDataType)dataType;
 ...
 * @param dataType The type of data (e.g., datafile, user profile, event dispatcher, etc.)
 */
+ (nullable NSString *)stringForDataTypeEnum:(EOCDataStoreDataType)dataType;
 ...
 * @param eventType The event type of the data.
 */
+ (nullable NSString *)stringForDataEventEnum:(EOCDataStoreEventType)eventType;
